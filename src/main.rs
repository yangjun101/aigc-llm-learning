...
use hello::ask_bedrock;
use hello::configure_aws;
use hello::RunType;

use hello::captioner::caption_image;
use hello::captioner::list_files_in_path_by_extension;
use hello::captioner::write_captions;
use hello::captioner::Image;
use hello::captioner::OutputFormat;
...
async fn main() -> Result<()> {
    ...
    // configuring the SDK
    let config = configure_aws(String::from("us-east-1")).await;
